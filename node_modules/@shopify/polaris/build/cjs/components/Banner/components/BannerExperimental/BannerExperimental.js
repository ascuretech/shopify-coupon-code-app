...
var BannerExperimental$1 = require('./BannerExperimental.scss.js');
...
function BannerExperimental({
  ...
  const bannerStatus = Object.keys(utilities.bannerAttributes).includes(status) ? status : 'info';
  const bannerColors = utilities.bannerAttributes[bannerStatus][withinContentContainer ? 'withinContentContainer' : 'withinPage'];
  const sharedBannerProps = {
    ...
    bannerIcon: hideIcon ? null : /*#__PURE__*/React.createElement("span", {
      className: BannerExperimental$1.default[bannerColors.icon]
    }, /*#__PURE__*/React.createElement(Icon.Icon, {
      source: icon ?? utilities.bannerAttributes[bannerStatus].icon
    })),
    ...
    dismissButton: onDismiss ? /*#__PURE__*/React.createElement(Button.Button, {
      ...
      icon: /*#__PURE__*/React.createElement("span", {
        className: BannerExperimental$1.default[isInlineIconBanner ? 'icon-subdued' : bannerColors.icon]
      }, /*#__PURE__*/React.createElement(Icon.Icon, {
