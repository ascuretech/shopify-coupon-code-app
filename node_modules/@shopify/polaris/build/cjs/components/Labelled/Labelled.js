...
function Labelled({
  ...
  const className = css.classNames(labelHidden && Labelled$1.default.hidden, disabled && Labelled$1.default.disabled, polarisSummerEditions2023 && readOnly && Labelled$1.default.readOnly);
